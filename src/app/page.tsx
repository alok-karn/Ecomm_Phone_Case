                ...
                <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
                    <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
                        <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                            <div className="absoulte w-28 left-0 -top-20 hidden lg:block">
                                <img
                                    src="/camera-removebg-preview.png"
                                    alt="snake"
                                    className="w-full"
                                />
                            </div>
                            ...
                            <p className="mt-8 text-lg lg:pr-10 max-2-prose text-center lg:text-left text-balance md:text-wrap">
                                Capture your favorite moments and carry them
                                with you wherever you go&nbsp;
                                <span className="font-semibold">
                                    one-to-one phone case.
                                </span>{" "}
                                Choose from a variety of styles and designs to
                                create a case that is uniquely yours.
                            </p>
                    ...
                    <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
                        <div className="relative md:max-w-xl">
                            ...
                            />
                            <Phone className="w-64" imgSrc="/2.jpg" />
                        </div>
                    </div>
                </MaxWidthWrapper>
            </section>
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    "The case feels durable and the print
                                    quality is amazing. I love the design and
                                    the fact that I can carry my favorite
                            ...
                            <div className="flex gap-4 mt-2">
                                ...
                                <div className="flex flex-col">
                                    <p className="font-semibold">Maxtern</p>
                        ...
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    ...
                                    pretty heavy scratches on all of my last
